...
function edit2_Callback(hObject, eventdata, handles)
    %MODIFICA EL PERIODO
    global Periodo G Retardo Gz texto2  
    Periodo=get(handles.edit2,'Value');
    disp(Periodo)
    if isempty(G)
        msgbox('Ingrese una función de trasnferencia.');
        return;
...
function eperiodo_Callback(hObject, eventdata, handles)
 global Periodo G Gzpk Gz 
Periodo=str2double(get(hObject,'String'));
[z,p,k]=tf2zpk(cell2mat(G.Numerator),cell2mat(G.Denominator))
Gzpk=zpk([z],[p],[k]);
disp(Gzpk)
 Gzzpk=c2d(G,Periodo,'zoh');
 Gz=c2d(Gzpk,Periodo,'zoh');
        ...
        text('Interpreter','LaTex','string',texto2,'FontSize',24);
        axis off
    % hObject    handle to eperiodo (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of eperiodo as text
%        str2double(get(hObject,'String')) returns contents of eperiodo as a double


% --- Executes during object creation, after setting all properties.
function eperiodo_CreateFcn(hObject, eventdata, handles)
    % hObject    handle to eperiodo (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
